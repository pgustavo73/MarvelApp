package com.pgustavo.marvelapp.di
...
import com.pgustavo.marvelapp.util.Constants
import com.pgustavo.marvelapp.util.Constants.BASE_URL
import com.pgustavo.marvelapp.util.Constants.DATABASE_NAME
...
object Module {
    ...
    @Singleton
    @Provides
    fun provideDatabase(dataBase: DataBase) = dataBase.characterDao()
    ...
    @Singleton
    @Provides
    fun provideRetrofitApi(retrofit: Retrofit): ServiceApi {
